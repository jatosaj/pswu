...
# Total number of times the script should reboot the machine
$TotalReboots = 1            
# The unique Instance ID of the device to be removed (found in Device Manager)
$DeviceInstanceID = "foo-bar" 
# The specific INF file name of the driver to be deleted
$DriverINF = "oem93.inf"      
# The location where the persistent script will be saved
$Destination = "$env:ProgramData\pswu.ps1" 
# The location where the script will write its log file
