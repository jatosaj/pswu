...
# Configured for Lenovo ThinkPad P15 Gen 2

$TotalReboots = 1                         # Total number of times the script should reboot the machine
$DeviceInstanceID = "UEFI\RES_{2F45F824-5964-4CF7-A20E-6B2A1E3E69F0}\0"              # The unique Instance ID of the device to be removed. Where to find it: In Device Manager, right-click the device > Properties > Details tab > Select Device instance path from the dropdown.
$DriverINF = "oem93.inf"                     # The specific INF file name of the driver to be deleted. Where to find it: In Device Manager, right-click the device > Properties > Details tab > Select Inf name from the dropdown. 
